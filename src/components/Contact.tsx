...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 px-4 bg-dark-surface rounded-lg shadow-lg">
      <h2 className="text-4xl font-bold text-center mb-12 text-text-light">Contacto</h2>
      <div className="max-w-xl mx-auto text-center space-y-6">
        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          <a
            ...
            className="text-accent-purple hover:text-accent-blue text-xl font-medium flex items-center"
          >
