    ...
    >
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        {personalData.projects.map((project, index) => (
          <a href={project.github} target="_blank" rel="noopener noreferrer" key={index}>
            <motion.div 
              className="group relative bg-[var(--color-dark-bg)] rounded-lg shadow-md overflow-hidden h-full"
              whileHover={{ y: -5 }}
            >
              {/* Default Content */}
